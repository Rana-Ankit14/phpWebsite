		<div class="d-flex justify-content-center col-md-12">
			...
			<div class="radio">    		
				...
				<input type="radio" placeholder="Email" required name="preference" value="veg"  /><label>Veg</label>&nbsp;
				<input type="radio" placeholder="Email" required name="preference" value="nonVeg"  /><label>Non-Veg</label>
			</div>
			</div>
			...
			<div class="form-group">
				<button type="submit" class="btn btn-primary" name="signupCustomer" value="Sign up">Sign up</button>
